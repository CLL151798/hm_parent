...
<h1>
    ...
    <span id="search_id" class="action-span1"> - 修改客户 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <s:form action="customer_update" >
    	<%--ID隐藏域，用于后台更新此用户 --%>
        ...
        <table width="100%" id="general-table">
            <tr>
                ...
                <td>
                  ...
                  <s:textfield name="custName" value=""/>  <font color="red"><s:property value="fieldErrors.custName[0]"/>*</font>
                </td>
            </tr>
            <tr>
