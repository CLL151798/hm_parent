...
<script type="text/javascript">
	...
	$(function(){
		...
		$.post("${pageContext.request.contextPath}/customer_loadCustomers",function(data){
			...
			//customersID
			$(data).each(function(){
				var option = "<option value="+this.custId+">"+this.custName+"</option>";	
...
<h1>
    ...
    <span id="search_id" class="action-span1"> - 新增联系人 </span>
    <div style="clear:both"></div>
</h1>
<div class="main-div">
    <s:form action="/linkman_save" >
